  ...
  return (
    <>
      <NavigationContainer>
        ...
        <Tab.Navigator>
          <Tab.Screen options={{ tabBarIcon: () => (<MaterialCommunityIcons name="home" size={40}></MaterialCommunityIcons>),
                    headerShown: false}} name="Home"  component={Main} />
          <Tab.Screen options={{ tabBarIcon: () => (<MaterialCommunityIcons name="account-multiple" size={40}></MaterialCommunityIcons>),
                    headerShown: false}} name="Users" component={Users} />
          <Tab.Screen options={{
